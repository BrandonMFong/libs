...
String::String(char * str) : Array<char, size_t, 2<<6>() {
...
String::String(const Data & data) : Array<char, size_t, 2<<6>() {
...
String::String(const char * format, va_list valist) : Array<char, size_t, 2<<6>() {
	char * str = BFStringCreateFormatArgListString(format, valist);
	this->set(str, strlen(str) + 1);
	BFFree(str);
}

String::String(const char * format, ...) : Array<char, size_t, 2<<6>() {
	va_list valist;
